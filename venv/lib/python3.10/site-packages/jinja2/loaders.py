...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'animasiya.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/animasiya.html'`` the file from the app1 package is loaded,
    by loading ``'app2/animasiya.html'`` the file from the second.
    """
